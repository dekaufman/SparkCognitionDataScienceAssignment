...
```{r}
# Manual override:  Even when `ubracing` picks ubNCL, I judge that the ubSMOTE results 
# are more interesting and more what I want from the model with regard to emphasizing 
# the positive response class and reducing false negatives
results$best = 'ubSMOTE'
